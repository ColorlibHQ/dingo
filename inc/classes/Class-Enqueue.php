 ...
 */
	...
	class dingo_Enqueue{
		...
		public function dingo_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'dingo_frontend_enqueue_scripts', ) );
		}

		public function dingo_frontend_enqueue_scripts( ){
