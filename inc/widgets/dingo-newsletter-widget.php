...
class Dingo_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Dingo ] Newsletter Form', 'dingo' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'dingo' ), )
        );
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'dingo' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'dingo'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'dingo'); ?> </p>
...
} // Class dingo_newsletter_widget ends here


// Register and load the widget
function dingo_newsletter_load_widget() {
	register_widget( 'Dingo_newsletter_widget' );
}
add_action( 'widgets_init', 'dingo_newsletter_load_widget' );