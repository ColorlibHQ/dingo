...
----------------------------------------*/
class dingo_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('dingo_instagram_photo',esc_html__('[ Dingo ] Intagram Photo','dingo'),array(
			'description' => esc_html__('Dingo Instagram Photo Widget','dingo'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'dingo');
		$insta_user = isset( $instance['insta_user'] ) ? $instance['insta_user'] : 'mdhasanfardous';
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'dingo'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'dingo'); ?></label>
...
if(!function_exists('dingo_instagram_widgets')):
	function dingo_instagram_widgets(){
		register_widget('dingo_instagram_photo');
	}
	add_action('widgets_init','dingo_instagram_widgets');
endif;
