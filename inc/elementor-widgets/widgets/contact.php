...
/**
 *
 * dingo elementor about page section widget.
 *
 * @since 1.0
 */
class Dingo_Contact extends Widget_Base {

    public function get_name() {
        return 'dingo-contact';
    }

    public function get_title() {
        return __( 'Contact', 'dingo' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'dingo' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'dingo' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'dingo' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'dingo' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'dingo' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'dingo' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => dingo_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'dingo' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'dingo' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'dingo')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'dingo' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
