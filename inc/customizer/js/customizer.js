(function( $ , api){
    ...
    api.section( 'dingo_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'dingo_about_section' , function( section ){
    ...
    api.section( 'dingo_blog_section' , function( section ){
    ...
    api.section( 'dingo_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-dingo_contact_custom_formshortcode'),
                selector = $('#_customize-input-dingo_contact_formshortcode');
    ...
    // General section
    api.section( 'dingo_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#dingo_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-dingo_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-dingo_preloader_color' );
            ...
            var $backtotop          = $( '#dingo_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-dingo_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-dingo_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'dingo_footer_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            var $widget_toggle      = $('#dingo_footer_widget_toggle');
