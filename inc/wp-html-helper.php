...
// image default alt
if( !function_exists( 'dingo_img_default_alt' ) ){
	function dingo_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'dingo_img_tag' ) ){
	function dingo_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'dingo_anchor_tag' ) ){
	function dingo_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'dingo_heading_tag' ) ){
	function dingo_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'dingo_paragraph_tag' ) ){
	function dingo_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'dingo_other_tag' ) ){
	function dingo_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'dingo_button_element ' ) ){
	function dingo_button_element( array $args ){
