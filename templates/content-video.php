...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-video'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  dingo_blog_posts_meta
		 *
		 * @Hooked dingo_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'dingo_blog_posts_meta' );
		 ...
		 * @Hook  dingo_blog_posts_excerpt
		 *
		 * @Hooked dingo_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'dingo_blog_posts_excerpt' );
