/*! ColorlibUI 3.0.0 — core, legacy-carousel, ajaxchimp. Built for this theme from core + the modules it uses. */
/**
...
/* Dingo's original ColorlibUI carousel and lightbox (cl-* markup). */
(function () {
  'use strict';
  var UI = window.ColorlibUI;
  var PREFERS_REDUCED = UI.reducedMotion;
  var debounce = UI.debounce;
  /* ------------------------------------------------------------------ *
   * Carousel
   *
